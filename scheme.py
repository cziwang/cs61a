...
class Frame(object):
    ...
    def make_child_frame(self, formals, vals):
        ...
        def child_helper(formals, vals, env):
            if not formals and not vals:
                return
            env.define(formals.first, vals.first)
            child_helper(formals.rest, vals.rest, env)

        child_helper(formals, vals, child)
        return child
